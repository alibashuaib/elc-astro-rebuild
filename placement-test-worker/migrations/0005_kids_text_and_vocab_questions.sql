...
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C1-2', 'kids', 'C1', 'mcq', 'Reading: Talal and Ali -- Talal likes English.', '["False", "True"]', 0, NULL);
...
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C1-4', 'kids', 'C1', 'mcq', 'Reading: Talal and Ali -- Ali is from Saudi Arabia.', '["False", "True"]', 0, NULL);
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C1-5', 'kids', 'C1', 'mcq', 'He gave ____ a book.', '["me", "I", "my", "mine"]', 0, NULL);
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C1-6', 'kids', 'C1', 'mcq', 'This is the man ____ car broke down.', '["which", "whose", "who''s", "who"]', 1, NULL);
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C2-1', 'kids', 'C2', 'mcq', '____ six o''clock, I get up.', '["on", "for", "at", "in"]', 2, NULL);
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C2-2', 'kids', 'C2', 'mcq', 'Where is Ahmed? He is ____ in the yard.', '["plays", "play", "played", "playing"]', 3, NULL);
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C2-3', 'kids', 'C2', 'mcq', 'Where do sharks live? They live in ____.', '["seas", "deserts", "jungles", "rivers"]', 0, NULL);
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C2-4', 'kids', 'C2', 'mcq', 'Which is the biggest animal in the world? It is ____.', '["the giraffe", "the whale", "the hippo", "the elephant"]', 1, NULL);
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C2-5', 'kids', 'C2', 'mcq', 'What can monkeys do? They can ____.', '["jump", "sing", "climb", "fly"]', 2, NULL);
INSERT INTO questions (id, track, level, type, prompt, options, correct_index, expected_answer) VALUES ('kids-C2-6', 'kids', 'C2', 'mcq', 'What does a crocodile have?', '["a thin tail", "big ears", "a long neck", "short legs"]', 3, NULL);
