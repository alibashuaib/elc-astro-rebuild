...
export const ui = {
  en: {
    ...
    'placementTest.capitalLetters': 'Capital letters',
    'placementTest.smallLetters': 'Small letters',
    'placementTest.numberInstruction': 'Drag a number into the empty space.',
  ...
  ar: {
    ...
    'placementTest.capitalLetters': 'الحروف الكبيرة',
    'placementTest.smallLetters': 'الحروف الصغيرة',
    'placementTest.numberInstruction': 'اسحب الرقم إلى المكان الفارغ.',
